/*Программа должна выводить количество населения самых крупных городов мира и сравнивать их
с самым большим городом — Токио. Но алгоритм программы немного нарушен. Для исправления ошибки
тебе необходимо сделать так, чтобы в строке с выводом информации о самом крупном городе мира
...
Требования:
        ...
        •	Для вывода информации о самом крупном городе должны использоваться статические
        переменные класса city и population.
...
public class Task0028 {
    ...
    public static void printCityPopulation(String city, double population){
        ...
        System.out.println("В то время как в самом густонаселенном городе " + Task0028.city + " население составляет " + Task0028.population + " млн человек.");
    }
}
