...
•	Программа должна выводить сообщение: "Студента с таким номером не существует" каждый раз
    при возникновении ArrayIndexOutOfBoundsException.
•	В программе должен быть один блок try и два блока catch.*/

package taskiFrom0161To0180.task0179;
